...
<nav>
          ...
          <div class="navigation-bar">
              <ul>
                  ...
                  <li class="active"><a href="menu.php">Menu<span class="underline"></span></a></li>
...
<h3 class="element-big-content-title">Main <strong>Dishes</strong></h3>
<?php
...
<tr id = <?php echo $row["id"]; ?>>
					<div class="restaurant-menu-title">
						...
						<div class="restaurant-menu-price">Php<?php echo $row["price"]; ?>.00</div>
					</div>
...
<div class="copyright">
      ...
      <a href="menu.php"><i class="fas fa-angle-double-up arrow-up"></i></a>
      <ul class="info">
          <li>&copy; K&R 2023</li>
